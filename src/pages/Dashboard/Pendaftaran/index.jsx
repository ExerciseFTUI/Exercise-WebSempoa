...
export default function Pendaftaran() {
  ...
  return (
    <div className="flex flex-col bg-orange-sempoa overflow-clip h-screen">
      ...
      <div className="grid grid-cols-7 gap-y-6 m-6 p-6 bg-white rounded-2xl text-lg items-center h-full">
        ...
        <input
          ...
          name="regis_date"
          id="regis_date"
          className="col-span-2 p-2 px-6 bg-white border-2 border-orange-sempoa rounded-3xl focus:outline-none"
        />
        ...
        <button
          onClick={createMurid}
          className="col-span-7 m-6 btn bg-orange-sempoa text-white hover:bg-orange-darker w-32 justify-self-center"
        >
          Submit
        </button>
      </div>
