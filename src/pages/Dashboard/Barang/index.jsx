...
export default function Barang() {
  ...
  return (
    <div className="bg-orange-sempoa w-full flex flex-col overflow-hidden">
      <div className="bg-orange-darker font-Inter text-white py-6 px-12 flex flex-col md:flex-row justify-between gap-3">
        <div className="flex items-end gap-2 md:flex-col md:items-start">
