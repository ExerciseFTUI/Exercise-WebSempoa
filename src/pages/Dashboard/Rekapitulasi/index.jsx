...
export default function Rekapitulasi() {
  ...
  return (
    <div className="bg-orange-sempoa flex flex-col w-full h-screen relative">
      <div className="bg-orange-darker text-white flex justify-between items-center py-4 px-12">
        <div className="flex flex-col gap-3">
          <h1 className="text-2xl">
            Rekapitulasi {page[0].toUpperCase() + page.slice(1, page.length)}
          </h1>
          ...
          <div className="flex gap-2">
            ...
            <button
              title="information"
              className="font-bold px-4 rounded-full border-2 border-white outline-none"
      ...
      <div
        className="absolute w-full h-full z-10 p-12 backdrop-blur-sm ease-in-out duration-300"
        style={{ top: showInformation ? 0 : "-100%" }}
      >
        <div
          id="information-tab"
          className="bg-white w-full h-full p-8 rounded-3xl border-2 border-black space-y-2 font-medium relative"
        >
          ...
          <button
            title="close-tab"
            className="absolute top-4 right-8 text-2xl outline-none font-extrabold border-2 border-black rounded-full px-2 hover:scale-90 ease-in-out duration-200"
