...
export default function Pembayaran() {
  ...
  const getData = async () => {
    try {
      ...
      const { data } = await axios.post(`${URL}/murid/filter-by-month-year?${params}`);
  ...
  return (
    <div className="flex-auto bg-orange-sempoa overflow-x-hidden">
      <div className="flex justify-between items-center bg-orange-darker font-Inter text-white p-6 px-12">
        ...
        <span className="text-3xl font-bold">Pembayaran</span>
      </div>
      ...
      <div className="px-12 p-6 space-y-6 grid">
        <div className="grid grid-cols-3 space-x-2">
          <div className="col-span-2">
            ...
            <h1 className="text-white font-medium">{"Sudah Bayar: " + sudah}</h1>
            <h1 className="text-white font-medium">{"Belum Bayar: " + belum}</h1>
